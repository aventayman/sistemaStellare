...
public abstract class InterfacciaUtente {
    ...
    /**
     * L'interfaccia utente che permette di visualizzare a schermo se nel sistema si verificano le collisioni.
     * @param sistema sistema in questione
     */
    public static void printCollisione(SistemaStellare sistema) {
        if (sistema.isCollisionePresente())
            System.out.println("OH NO! Succederà una catastrofe! Ohibò!");
        else
            System.out.println("Tutto regolare. Nessuna collisione prevista.");
    }
}
